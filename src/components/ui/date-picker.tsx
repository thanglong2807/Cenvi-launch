    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            "w-full h-[40px] px-1.5 justify-start text-left font-normal",
      ...
      <PopoverContent className="w-auto bg-white p-0" align="start">
        <CalendarComponent
          ...
          classNames={{
            months: "flex-col flex  sm:flex-col space-y-4 sm:space-x-4 sm:space-y-0",
            month: "space-y-4",
            ...
            day: cn(
              "h-9 w-9 text-center p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 rounded-md transition-colors"
            ),
